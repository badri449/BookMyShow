...
<body background="../images/background.jpg" >
  ...
  <article class="card-body mx-auto" style="max-width: 400px;">
    <h4 class="card-title mt-3 text-center" style="color:black;">Log In as Customer</h4>
    <p class="text-center" style="color:black;">LogIn with your Details</p>


    <form method = "post" action="../user/int_login_customer.php">
      ...
      <p class="text-center" style="color:black;">Don't Have an account?
      <a href="http://localhost/DBMS_Project/user/register_customer.php">Register Here</a> </p>
  </form>
  </article>
   <!-- card.// -->
