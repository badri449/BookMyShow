...
<body class = "vis">
    ...
    <?php
        ...
        $sql = "select * from customer where user_name = \"".$user_str."\" and password = \"".$password_str."\"";
                        ...
                        <hr>
                          <form class="form" action="##" method="post" id="registrationForm">
                              ...
                              <div class="form-group row">
                                  ...
                                  <div class="col-md-6">
                                      <label for="email"><h4>Credit Card</h4></label>
                                      <h5><?php echo $row["credit_card"] ?></h5>
                                      <!-- <input type="email" class="form-control" name="email" id="email" placeholder="you@email.com" title="enter your email."> -->
                                  </div>
                              <!-- </div>
                              <div class="form-group"> -->
                                  ...
                                  <div class="col-md-6">
                                      <label for="email"><h4>Debit Card</h4></label>
                                      <h5><?php echo $row["debit_card"] ?></h5>
                                      <!-- <input type="email" class="form-control" id="location" placeholder="somewhere" title="enter a location"> -->
                                  </div>
                              </div>
                              <a href="update_user.php" class="btn btn-primary" role="button">Update Details</a>
                              <!-- <a href="##" class="btn btn-primary" role="button">Update ProfileImage</a> -->

                              <a href="update_wallet.php" class="btn btn-primary" role="button">Add Money</a>
                              <a href="show_transactions.php" class="btn btn-primary" role="button">My Movie Transactions</a>
                              <a href="../events/show_event_transactions.php" class="btn btn-primary" role="button">My Event Transactions</a>
                              <!-- <a href="show_rentable_transactions.php" class="btn btn-primary" role="button">Show My Rentable Transactions</a> -->
                              <a href="../rentable/show_active_rentables.php" class="btn btn-primary" role="button">My Active Rentables</a>
