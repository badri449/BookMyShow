...
<article class="card-body mx-auto" style="max-width: 400px;">
	...
	<form method = "post" action="int_reg_customer.php" enctype="multipart/form-data">
    ...
    <div class="form-group input-group">
    	...
    	[(ngModel)]='registerData.number' class="form-control" placeholder="Phone number" type="number" required>
    </div> <!-- form-group// -->
    ...
    <div class="form-group input-group">
      <div class="input-group-prepend">
        ...
        <input name="creditCard" class="form-control" placeholder="Credit Card" type="number" required>
   </div> <!-- form-group// -->
   <div class="form-group input-group">
     <div class="input-group-prepend">
       <span class="input-group-text"> <i class="fa fa-credit-card"></i> </span>
    </div>
       <input name="debitCard" class="form-control" placeholder="Debit Card" type="number" required>
  </div> <!-- form-group// -->
    ...
    <a href="http://localhost/DBMS_Project/user/login_customer.php">Log In</a> </p>
</form>
</article>
</div> <!-- card.// -->
