    	...
    	<div class="col-sm-9">
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="home">
                <hr>
                  <form class="form" action="int_update_wallet.php" method="post" >
                      <div class="form-group row">

                          <div class="col-md-6">
                              <label for="first_name"><h4>Enter Money</h4></label>
                              <input type="text" class="form-control" name="wallet"  placeholder="enter amount" title="enter your first name if any." required>
                          </div>
                      <!-- </div> -->
