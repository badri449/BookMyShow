    	...
    	<div class="col-sm-9">
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="home">
                <hr>
                  <form class="form" action="int_register_rentables.php" method="post"  >
                      ...
                      <div class="form-group row">
                          <div class="col-md-6">
                             <label for="bp"><h4>Buying Price</h4></label>
                              <input type="text" class="form-control" name="bp" placeholder="Buying Price"required >
                          </div>
                          <div class="col-md-6">
                             <label for="rp"><h4>Renting Price</h4></label>
                              <input type="text" class="form-control" name="rp" placeholder="Renting Price" required>
                          </div>
                      </div>
                      ...
                      <div class="form-group row">
                          ...
                          <div class="col-md-6">
                             <label for="dur"><h4>Duration(min)</h4></label>
                      ...
                      <div class="form-group row">
                          ...
                          <div class="col-md-6">
                             <label for="season"><h4>Season</h4></label>
