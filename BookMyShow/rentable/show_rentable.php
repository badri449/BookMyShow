...
<?php
  // echo "<br /><br /><br /><br /><br />";
    ...
    $host_str = $_SESSION["userName"];
    require("../mysqli_connect.php");
    $s = "select ID from host where user_name = \"".$host_str."\" ";
    $result = $conn -> query($s);
    // echo "<br /><br /><br /><br />";
    ...
    $sql = "CALL host_rentable(:h)";
    $stmt = $pdo->prepare($sql);
    // echo "abt to bind";

    $stmt->bindParam(':h', $host_id, PDO::PARAM_INT);
    $stmt->execute();
    // echo "binded";
...
<div class="row">
  <div class="col-md-6">
      <a href="register_rentables.php" class="btn btn-primary" role="button">Add Rentable</a>
    </div>
</div>
