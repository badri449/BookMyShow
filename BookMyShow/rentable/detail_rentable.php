...
<div class="row">
  <div class="col-md-6">
      <a href="show_rentable_cast.php" class="btn btn-primary" role="button">Show Rentable Movie Cast</a>
    </div>
    <div class = "col-md-6">
      <a href="show_rentable_genre.php" class="btn btn-primary" role="button">Show Rentable MovieGenre</a>
    </div>
</div>
    <script src = "../js/jquery-3.3.1.slim.min.js"></script>
    <script src = "../js/js_bootstrap.min.js"></script>
