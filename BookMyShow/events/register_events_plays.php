    	...
    	<div class="col-sm-9">
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="home">
                <hr>
                  <form class="form" action="int_register_events_and_plays.php" method="post"  >
                      ...
                      <!-- <div class="form-group"> -->
                          ...
                          <div class="col-md-6">
                            <label for="duration"><h4>Venue</h4></label>
                      ...
                      <!-- <div class="form-group row">
                          <div class="col-md-6">
                             <label for="host_id"><h4>Host_Id</h4></label>
                              <input type="text" class="form-control" name="host_id" placeholder="HostID"required >
                          </div>
