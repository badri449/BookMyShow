    	...
    	<div class="col-sm-9">
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="home">
                <hr>
                  <form class="form" action="int_register_movie.php" method="post" enctype="multipart/form-data" >
                      ...
                      <!-- <div class="form-group"> -->
                          ...
                          <div class="col-md-6">
                            <label for="duration"><h4>Duration</h4></label>
                              <input type="text" class="form-control" name="duration"  placeholder="Duration Time" required >
                          </div>
                      </div>
                      ...
                      <div class="form-group row">
                          <div class="col-md-6">
                             <label for="release_date"><h4>Release Date</h4></label>
                              <input type="text" class="form-control" name="release_date" placeholder="release date"required >
                          </div>
                          <div class="col-md-6">
                      ...
                      <div class="form-group input-group">
                        <div class="col-md-6">
                          ...
                          <label for="image"><h4>Poster:</h4></label>
