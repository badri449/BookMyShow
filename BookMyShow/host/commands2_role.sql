...
grant select(name,phone_no,wallet,email,credit_card,debit_card,image,ID) on customer to customer;
grant update(name,phone_no,wallet,email,credit_card,debit_card,image) on customer to customer;

grant execute on procedure booking_history to customer;
grant execute on procedure movcas to customer;
grant execute on procedure movgen to customer;

grant select on movie_theatre to customer;
grant execute on procedure display_movies to customer;

grant execute on procedure screen_tickets to customer;
grant execute on procedure book_tickets to customer;
grant execute on procedure eventgen to customer;
grant execute on procedure display_events to customer;

grant execute on procedure book_events to customer;
grant execute on procedure booking_history_events to customer;
grant execute on procedure rencas to customer;
grant execute on procedure rengen to customer;

grant execute on procedure display_rentables to customer;
grant execute on procedure buy_rentable to customer;
grant execute on procedure rent_rentable to customer;
grant execute on procedure user_active_rentable to customer;


create role host;

grant select(name,phone_no,wallet,email,image,ID) on host to host;
grant update(name,phone_no,wallet,email,image) on host to host;

grant execute on procedure host_theatre to host;

grant execute on procedure movcas to host;

grant execute on procedure screen_insert to host;
grant execute on procedure screen_update to host;

grant execute on procedure add_movie to host;
grant execute on procedure cast_movie to host;

grant execute on procedure genre_movie to host;
grant execute on procedure movgen to host;

grant select on movie_theatre to host;
grant execute on procedure display_movies to host;

grant execute on procedure add_events_plays to host;

grant execute on procedure host_events_plays to host;
grant execute on procedure eventgen to host;

grant execute on procedure genre_events to host;
grant execute on procedure display_events to host;


grant execute on procedure host_rentable to host;
grant execute on procedure add_rentables to host;
grant execute on procedure rencas to host;
grant execute on procedure rengen to host;

grant execute on procedure genre_rentable to host;
grant execute on procedure cast_rentable to host;
grant execute on procedure display_rentables to host;
